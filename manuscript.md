...
그렇게 푹 잤다 싶었을 때쯤 현관 쪽에서 인기척이 들려왔다.

```
아~ 드디어 집사가 왔구나!!
```

하지만 웬걸.. 집사가 들어오는 게 아니라 집을 나가는 중이었다.
오랜만에 밖에서 쥐 잡기를 한 탓인지 고양이는 어젯밤 가족들이 집에 들어오는 것조차 모른 체 깊은 잠에 빠져버린 것이다.
당황한 탓에 멍을 때리고 있던 고양이는 아직 등교를 하지 않은 막내딸을 보고 달려가 안긴다.
